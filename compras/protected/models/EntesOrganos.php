...
class EntesOrganos extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'enteAdscrito' => array(self::BELONGS_TO, 'EntesOrganos', 'ente_adscrito'),
			'entesOrganoses' => array(self::HAS_MANY, 'EntesOrganos', 'ente_adscrito'),
			'proyectosAcciones' => array(self::HAS_MANY, 'ProyectosAcciones', 'ente_id'),
		);
	}
