...
class EntesOrganos extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nombre, tipo, codigo_onapre', 'required', 'on' => 'crearuel'),
			...
			array('rif', 'match', 'pattern' => '/^(j|J|v|V|e|E|G|g)([0-9]{8,8})([0-9]{1})$/', 'allowEmpty' => false, 'message'=>'El formato del rif no es válido. Formatos aceptados: G123456789 y J123456789', 'except'=>'crearuel'),
