...
class PresupuestoPartidas extends ActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'proyectoses' => array(self::MANY_MANY, 'Proyectos', 'presupuesto_partida_proyecto(presupuesto_partida_id, proyecto_id)', 'condition'=>'anho='.Yii::app()->params['trimestresFechas'][Yii::app()->session['trimestreSeleccionado']]['anho'].''),
			'presupuestoPartidaAcciones' => array(self::HAS_MANY, 'PresupuestoPartidaAcciones',  'presupuesto_partida_id', 'condition'=>'anho='.Yii::app()->params['trimestresFechas'][Yii::app()->session['trimestreSeleccionado']]['anho'].''),
