...
/**
 * This is the model class for table "public.proveedor_motivo".
 *
 * The followings are the available columns in table 'public.proveedor_motivo':
 * @property integer $id
 ...
 */
class ProveedorMotivo extends CActiveRecord
{
	/**
	...
	{
		return 'public.proveedor_motivo';
	}
	...
	public function rules()
	{
		...
		return array(
			array('proveedor_id, ente_organo_id, motivo', 'required'),
			array('proveedor_id, ente_organo_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, proveedor_id, ente_organo_id, motivo', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ProveedorMotivo the static model class
	 */
