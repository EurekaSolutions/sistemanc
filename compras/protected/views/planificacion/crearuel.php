...
<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
    ...
    <h4 style="text-align: center;">CREAR UNIDAD EJECUTORA LOCAL (UEL)</h4>
    ...
    <?php //echo $form->textFieldGroup($model,'rif',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>100)))); ?>
    ...
    <?php $this->widget('booster.widgets.TbButton', array(
            'buttonType'=>'submit',
            'context'=>'primary',
            'label'=>$model->isNewRecord ? 'Crear UEL' : 'Guardar UEL',
        )); ?>
    </div>
